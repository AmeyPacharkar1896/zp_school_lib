...
//     print("nowwwwwwwwww");
//     print(query);
//     onClickSearch(query); // Changed method name to follow conventions
//     return Padding(
//       padding: const EdgeInsets.only(top: 15),
...
//   void onClickSearch(String query) async { // Method name changed to follow conventions
